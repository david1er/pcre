...
@Component({
  selector: 'app-consultation-bacii',
  templateUrl: './consultation-bacii.component.html',
  styleUrls: ['./consultation-bacii.component.css']
})
export class ConsultationBACIIComponent implements OnInit {
